...
if __name__ == '__main__':
    ...
    savePath = "/shared/Dataset/Clustering/sf2M_output/"
    ...
    # np.save(savePath + f"exact_euclidean_{k_max}_indices.npy", indices)    # shape: (n, k), dtype: int32
    ...
    #
    # indices = np.load(savePath + f"exact_euclidean_{k_max}_indices.npy")    # shape: (n, k), dtype: int64
    # distances = np.load(savePath + f"exact_euclidean_{k_max}_distances.npy")  # shape: (n, k), dtype: float32
    #
