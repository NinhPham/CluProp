...
if __name__ == '__main__':
    ...
    savePath = Path("~/Work/Datasets/Clustering/usps_output").expanduser()

    X = np.loadtxt("test/Dataset/usps-data.txt", delimiter=",")
    true_labels = np.loadtxt("test/Dataset/usps-labels.txt", delimiter=",")
